...
\connect <<PRODUCT_SERVICE_DB_NAME>>
GRANT USAGE, CREATE ON SCHEMA public TO <<PRODUCT_SERVICE_DB_USER>>;
ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO <<PRODUCT_SERVICE_DB_USER>>;
